...
This report documents the research undertaken for the MovieLens project submission in part fulfillment of the Harvard PH125.9x Data Science: Capstone module by the author, Frankie Inguanez. The data set chosen is the Dry Beans data set archived on the [UCI Machine Learning Repository](https://archive.ics.uci.edu/ml/data sets/Dry+Bean+data set) and researched by @KOKLU2020105507;. The objective of this data set is to correctly classify seven types of dry beans using 16 features which were extracted using computer vision. These features describe 12 dimension and 4 shape characteristics of each observation.
